...
<body class="nav-md">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group date" >
                                景点编号：<input id="deleteSceneryId" type="text" class="form-control" readonly="readonly"/>
                            </div>
                            <div class="input-group date" >
                                景点名称：<input id="deleteSceneryName" type="text" class="form-control" readonly="readonly" />
                            </div>
                            <div class="input-group date" >
                                景点价格：<input id="deleteSceneryPrice" type="text" class="form-control" readonly="readonly"/>
                            </div>
                            开放时间：
                            <div class="input-group date" id="myDatepicker" style="position: relative">
                                <input id="deleteSceneryOpenTime" type="text" class="form-control" readonly="readonly"/>
                            ...
                            <div class="form-group">
                                <div class="input-group date" >
                                    ...
                                    <div class="col-md-13 col-sm-12 col-xs-13">
                                        <textarea id="deleteSceneryIntroduce" rows="8" class="resizable_textarea form-control" placeholder="具体景点介绍..." readonly="readonly"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button id="deleteBtn" type="button" class="btn btn-primary">确认删除</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal -->
            </div>
	...
	<script type="text/javascript">
        ...
        //删除键
        $('#scenerys').on("click", ".deleteBtnGroup", function() {
            ...
            $("#deleteSceneryId").val(sceneryId);
            $("#deleteSceneryName").val(sceneryName);
            $("#deleteSceneryPrice").val(sceneryPrice);
            $("#deleteSceneryOpenTime").val(sceneryOpenTime);
            $("#deleteSceneryIntroduce").val(sceneryIntroduce);
            $("#myModal").modal();
        });
        //(模态框)确认删除键
        $("#deleteBtn").click(function(){
            var sceneryId = $("#deleteSceneryId").val();
            $("#myModal").modal("hide");
            $.ajax({
                url: "../scenery/deleteSceneryBySceneryId.action",
                type: "post",
                data: {
