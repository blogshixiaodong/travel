...
<body class="nav-md">
								...
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-12 form-group" style="margin-left: 30px">
										...
										<div class="input-group date" >
											景点名称：<input id="sceneryName" name="scenery.sceneryName" type="text" class="form-control" />
										</div>
										<div class="input-group date" >
											门票价格：<input id="sceneryPrice" name="scenery.sceneryPrice" type="text" class="form-control" />
										</div>
										开放时间：
										<div class="input-group date" id="myDatepicker" style="position: relative">
											<input id="sceneryOpenTime" name="scenery.sceneryOpenTime" type="text" class="form-control"/>
										...
										<div class="form-group">
											<div class="input-group date" >
												...
												<div class="col-md-13 col-sm-12 col-xs-13">
													<textarea id="sceneryIntroduce" name="scenery.sceneryIntroduce" rows="8" class="resizable_textarea form-control" placeholder="具体景点介绍..."></textarea>
													<br/><br/>
	...
	<%--fileupload--%>
	<script src="../vendors/fileinput/js/fileinput.min.js" type="text/javascript"></script>
