                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group date" >
                                酒店编号：<input id="updateHotelId" type="text" class="form-control" readonly="readonly"/>
                            </div>
                            <div class="input-group date" >
	...
	<script type="text/javascript">
		...
		var columns = [{
            ...
            formatter:function(value,row){
                return '<button class="btn btn-primary btn-xs updatebBtnGroup">'+"修改"+' </button>';
            }
        }];
        ...
        $('#hotels').on("click", ".updatebBtnGroup", function() {
            ...
            $("#updateHotelName").val(hotelName);
            $("#updateHotelPrice").val(hotelPrice);
            $("#updateHotelPhone").val(hotelPhone);
            $("#updateHotelAddress").val(hotelAddress);
