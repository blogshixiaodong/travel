  ...
  <body class="text-center">
    <form class="form-signin"  method="POST">
      <h1 class="h3 mb-3 font-weight-normal">Visitor Sign In</h1>
        ...
        <input type="text" id="inputAccount" name="visitorAccount.accountId" class="form-control" placeholder="Account" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="visitorAccount.password" class="form-control" placeholder="Password" required>
    ...
    <script type="text/javascript">
      $("#submit").click(function(){
        ...
        $.ajax({
          url: "visitorAccount/visitorLoginCheck.action",
          type: "post",
          data: {
